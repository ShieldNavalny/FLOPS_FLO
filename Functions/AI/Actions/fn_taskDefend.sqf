/* ----------------------------------------------------------------------------
Function: FLO_fnc_taskDefend

Description:
    A function for a group to defend a parsed location. Should be run locally.
...
Examples:
    (begin example)
        [this] call FLO_fnc_taskDefend
    (end)

Author:
    Rommel, SilentSpike, modified by Azraeelian Angel
---------------------------------------------------------------------------- */
params [
...
[_group, _position, _radius, 5, "sad", "safe", "red", "limited"] call FLO_fnc_taskPatrol; 