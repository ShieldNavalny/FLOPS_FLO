...
class C_LOCK
{
          idd=732801;
           ...
           fadeout=0;
			onload = "
				hint parseText ""<t color='#7CC2FF' font='PuristaBold' align = 'right' size='2'> (+) +1 Hour </t><br /><t color='#7CC2FF' font='PuristaBold' align = 'right' size='2'> (-) -1 Hour</t><br /><t color='#7CC2FF' font='PuristaBold' align = 'right' size='2'> (T) Skip Time</t>"";
				StatusInfo = false;
				titleFadeOut 0.01;
				PHOUR = 0;
			...
			onUnload = "
				hint '''';
				[ """", 0.2, 0, 9999, 0, 0, 7537 ] spawn BIS_fnc_dynamicText;
			";
		   controlsBackground[] = {};
           controls[] = {
			   btnF1,
